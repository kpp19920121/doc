...
|表单|VSS_Table||||||||
|:-|:-|:-:|:-|:-|:-|:-|:-:|:-|:-|
|**序号**|**字段**|**说明**|**数据类型**|**允许为空**|**数据类型**|**主键**|**单位**|**备注**|
|VSSID|VSS的本地ID（为VSS的唯一标示）|CHAR(size)|N|Y|-|-|
|UserID|上传VSS的用户的ID|CHAR(size)|N|Y|-|-|

|表单|SSTable||||||||
|:-|:-|:-:|:-|:-|:-|:-|:-:|:-|:-|
|**序号**|**字段**|**说明**|**数据类型**|**允许为空**|**数据类型**|**主键**|**单位**|**备注**|
|VSSID|SS所属的VSS的ID|CHAR(size)|N|Y|-|-|
|SFID|该SS中SF的唯一ID|CHAR(size)|N|Y|-|-|
|lng|SS的经度|FLOAT|Y|N|-|-|
|lat|SS的纬度|FLOAT|Y|N|-|-|
...
|:-|:-|:-:|:-|:-|:-|:-|:-:|:-|:-|
|**序号**|**字段**|**说明**|**数据类型**|**允许为空**|**数据类型**|**主键**|**单位**|**备注**|
|SFID|SF的ID|CHAR(size)|N|Y|-|-|
|filePath|SF（在服务器端）的文件位置|CHAR(size)|N|N|-|-|
|MD5_hash|SF的MD5哈希值（用于音频判重验证）|CHAR(size)|N|N|-|-|

|表单|LikeTable||||||||
|:-|:-|:-:|:-|:-|:-|:-|:-:|:-|:-|
|**序号**|**字段**|**说明**|**数据类型**|**允许为空**|**数据类型**|**主键**|**单位**|**备注**|
|VSSID|包含VSS的ID|CHAR(size)|N|Y|-|-|
|LikeUserID|点赞者的ID|CHAR(size)|N|Y|-|-|

|表单|CommentTable||||||||
|:-|:-|:-:|:-|:-|:-|:-|:-:|:-|:-|
|**序号**|**字段**|**说明**|**数据类型**|**允许为空**|**数据类型**|**主键**|**单位**|**备注**|
|VSSID|VSS的ID|CHAR(size)|N|Y|-|-|
|CommentUserID|评论者的ID|CHAR(size)|N|N|-|-|
...
|:-|:-|:-:|:-|:-|:-|:-|:-:|:-|:-|
|**序号**|**字段**|**说明**|**数据类型**|**允许为空**|**数据类型**|**主键**|**单位**|**备注**|
|Username|用户名|CHAR(size)|N|N|-|-|
|UserID|用户ID|CHAR(size)|N|N|-|-|
|Email|用户邮箱|CHAR(size)|N|N|-|-|
|Password|用户密码|CHAR(size)|N|N|-|-|
