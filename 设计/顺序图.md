...
boundary -> boundary: displayVSSList(listOfLocalVSS):void

loop
    alt CreateVSS
        user -> boundary: onCreateButtonClicked():void
        ...described in PlayVSS...
    else RenameVSS
        user -> boundary: onRenameButtonClicked():void
        ...described in RenameVSS...
    else DeleteVSS
        user -> boundary: onDeleteButtonClicked():void
        ...described in DeleteVSS...
    else UploadVSS
        user -> boundary: onUploadButtonClicked():void
        ...described in UploadVSS...
    else PreviewVSS
        user -> boundary: onPreviewButtonClicked():void
        alt local map
        ...
        user -> boundary: onPrevButtonClicked():void
...
user -> manage: onCreateButtonClicked():void
create page
manage -> page: <<create>>
alt create Map Mode VSS
    user -> page: onMapModeButtonClicked():void
    create map
    page -> map: <<create>>
    ...Go to CreateMapVSS...
else create Concert Mode VSS
    user -> page: onConcertModeButtonClicked():void
    create concert
    page -> concert: <<create>>
...
![CreateMapModeVSSUIMockUP](./Diagrams/CreateMapModeVSSUIMockUP.svg)
...
![CreateConcertModeVSSUIMockUP](./Diagrams/CreateConcertModeVSSUIMockUP.svg)
