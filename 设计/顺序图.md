...
Communicator->WebServer:LoginRequest(UserInformation):boolean
WebServer->UserDatabase:Search(UserInformation):int,int
UserDatabase->UserDatabase:SearchUser(UserInformation):int,int
...
![LocalVSSManagerUIMockUP](./Diagrams/LocalVSSManagerUIMockUP.svg)
