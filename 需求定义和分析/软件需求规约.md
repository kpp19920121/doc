...
|          实体类名称          |                             属性                             |                            关联类                            |                             定义                             |
| :--------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|             User             | userID: int<br />username: String<br />password: String<br />e-mail: String<br />userProfile |             LocalSoundLibrary<br />Sensor<br />              | User类保存了使用该系统的一个用户的相关信息，包括用户名、密码、邮箱及用户ID |
...
|    LocalSoundSpaceLibrary    | virtualSoundSpaces: List<br />libraryID: int<br />libraryName: String | User<br />MapModeVirtualSoundSpace<br />ConcertModeVirtualSoundSpace | LocalSoundSpaceLibrary类是用户的所有VSS的本地资源库，包括已经下载完毕的和用户自己制作的MapModeVSS以及ConcertModeVSS，保存用户制作的所有VSS的列表、库ID、库名称 |
|   OnlineSoundSpaceLibrary    | virtualSoundSpaces: List<br />libraryID: int<br />libraryName: String<br />Comment<br />Like | User<br />MapModeVirtualSoundSpace<br />ConcertModeVirtualSoundSpace | OnlineSoundSpaceLibrary类是供用户浏览的其他用户所制作上传的在线VSS资源库，包括MapModeVSS以及ConcertModeVSS，保存这些VSS的列表、库ID、库名称 |
...
OnlineSoundSpaceLibrary "1" -- "*" Comment
OnlineSoundSpaceLibrary "1" -- "*" Like
