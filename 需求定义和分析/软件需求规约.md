...
|   OnlineSoundSpaceLibrary    | virtualSoundSpaces: List<br />libraryID: int<br />libraryName: String | User<br />MapModeVirtualSoundSpace<br />ConcertModeVirtualSoundSpace | OnlineSoundSpaceLibrary类是供用户浏览的其他用户所制作上传的在线VSS资源库，包括MapModeVSS以及ConcertModeVSS，保存这些VSS的列表、库ID、库名称 |
