...
| SoundSource | SoundSourceID: int<br />SoundFragment: Soundformat<br />SoundName: String<br />SoundLatitude: double<br />SoundLongtitude: double<br />SoundAltitude: double<br />SoundVolume: int<br />SoundPattern: String | | 虚拟声源类，保存虚拟声源文件、虚拟声源名称、经纬度、高度、音量、播放模式及虚拟声源ID |
| VirtualSoundSpace | SoundSources: List<br />VSSName: String<br />VSS_ID: int<br />OwnerID: int<br />VSS_Description: String<br /> | | 保存该用户上传的所有虚拟声源的列表，保存虚拟声源空间的名称、所有者ID、虚拟声源空间ID |
